...
if __name__ == '__main__':
    ...
    model = YOLO('/data1/wangqiurui/code/competition/tianchi/unseen/YOLOv11-RGBT/M3FD-yolo11s-RGBT-mid-to-late-fusion-e300-16-.pt')
    ...
    model.train(data='/data1/wangqiurui/code/competition/tianchi/unseen/YOLOv11-RGBT/ultralytics/cfg/datasets/unseen.yaml',
                ...
                name='yolo11n-RGBT-midlate-fusion-finetuneM3DF-6c',
                )