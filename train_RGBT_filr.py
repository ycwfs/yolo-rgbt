...
if __name__ == '__main__':
    ...
    model = YOLO('/data1/wangqiurui/code/competition/tianchi/unseen/YOLOv11-RGBT/FLIR_aligned3C-yolo11s-RGBT-midfusion-e300-16-.pt')
    ...
    model.train(data='/data1/wangqiurui/code/competition/tianchi/unseen/YOLOv11-RGBT/ultralytics/cfg/datasets/unseen.yaml',
                ...
                channels=4,
                project='runs/rgb_ir',
                name='yolo11s-RGBT-midfusion-finetunefilr',
                )